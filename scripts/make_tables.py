"""
Build the mean-differences table in the README.

For every sector and scenario, the average over 2025-2050
...
component, with the range across scenarios in the last column. The input is
results/scenario_monthly_predictions.csv. A sanity check guards it: the range must be about 0.39 for Energy, about 0.31 for
...
def sanity_check(table):
    """Stop the build if the scenario ranges are not the expected ones."""
